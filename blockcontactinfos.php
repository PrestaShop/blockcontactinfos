...
class Blockcontactinfos extends Module implements WidgetInterface
{
    ...
    public function getWidgetVariables($hookName = null, array $configuration = [])
    {
        $contact_infos = array(
            ...
            'address' => nl2br(Configuration::get('BLOCKCONTACTINFOS_ADDRESS')),
            'phone' => sprintf($this->l('Tel %1$s'), Configuration::get('BLOCKCONTACTINFOS_PHONE')),
            'email' => sprintf($this->l('Email: %1$s'), Configuration::get('BLOCKCONTACTINFOS_EMAIL')),
        );
